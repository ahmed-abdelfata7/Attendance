...
Route::group(['prefix' => 'admin',  'middleware' => 'auth:web'], function(){
    ...
    Route::resource('reportTemplates','Admin\ReportTemplatesController');
    ...
    Route::get('toggleCheck/{id}/','Admin\ManualCheckController@toggleCheck');
    Route::get('toggleProject/{id}/','Admin\ProjectsController@toggleProject');
