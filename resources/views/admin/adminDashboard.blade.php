                ...
                <table class="table no-margin" id="example1">
                  ...
                  <tr>
                    ...
                    <td style="text-align:center;"> 
                                @if($row->active==1)
                                    <a href='{{ url("admin/toggleProject/$row->id") }}' class="btn btn-default btn-icon" id="delete"><span class="fa fa-toggle-on"></span></a>
                                @else
                                    <a href='{{ url("admin/toggleProject/$row->id") }}' class="btn btn-default btn-icon" id="delete"><span class="fa fa-toggle-off"></span></a>
                                @endif
                            </td>
                            <td>
                              @if($row->active==1)
