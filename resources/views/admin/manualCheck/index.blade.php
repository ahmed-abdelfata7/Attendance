                ...
                <tbody>
                  ...
                  @foreach($engineers as $row)
                    ...
                    @if($row->check_in==0 && $row->check_out==0)
                        <a href='{{ url("admin/toggleCheck/$row->id") }}' class="btn btn-default btn-icon" id="delete"><span class="fa fa-toggle-off"></span></a>
                    @else
                        <a href='{{ url("admin/toggleCheck/$row->id") }}' class="btn btn-default btn-icon" id="delete"><span class="fa fa-toggle-on"></span></a>
                    @endif
                    </td>
                    <td style="text-align:center;"> 
                    @if($row->check_in==0 && $row->check_out==0)
